<template>
  <div class="py-3rem">
    <div v-if="authStep==='login'" class="pt-1rem">
    ...
    <div v-else-if="authStep === 'select'">
      ...
      <button @click="connectMetamask" :disabled="connecting"
        ...
        <span class="text-color8B light:text-color7D underline font-bold">{{$t('signInView.metamask')}}</span>
...
import MetaMaskAccount from "@/views/login/MetaMaskAccount";
